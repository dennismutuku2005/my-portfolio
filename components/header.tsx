...
import { Github, Rocket, Menu } from "lucide-react"
        ...
        <div className="flex items-center justify-between h-10">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              className="p-2.5 rounded-xl bg-secondary/50 border border-border/50 text-muted-foreground hover:text-primary hover:border-primary/30 transition-all"
              aria-label="GitHub"
            >
